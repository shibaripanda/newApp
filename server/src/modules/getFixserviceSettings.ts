export const getFixserviceSettings = () => {
    ...
    const docprint = {
        ...
        time: 'пн-пт: 11:00 - 20:00, сб-вскр: 11:00 - 18:00',
        ...
        oznak: 'Заказчик ознакомлен с данным заказ-нарядом и принимает все условия.',
        soglas: 'Точная стоимость согласовывается в течении 10 дней, ОПЛАТА ПРОИЗВОДИТСЯ ТОЛЬКО ПОСЛЕ ОКОНЧАНИЯ РЕМОНТА',
        filial: 'Сухарево',
        telefonnumber: '+375 44 7310419 A1'
    }
